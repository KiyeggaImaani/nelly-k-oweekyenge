...
const songs = [
    { src: 'songs/Alobesa By Nelly K [Royal Buoy Beats].mp3', title: 'Alobesa' },
    { src: 'songs/Byewunyisa By Nelly K [Mastered By Royal Buoy Beats].mp3', title: 'Byewunyisa' },
    { src: 'songs/DJNYCE FT NELLY K -BEND DOWN.mp3', title: 'Bend Down (feat. DJNYCE)' },
    { src: 'songs/Emboozi Za banafu By Nelly K.mp3', title: 'Emboozi Za Banafu' },
    { src: 'songs/Mpele By Nelly K [Royal Buoy Beats] (1).mp3', title: 'Mpele' },
    { src: 'songs/Muwumbo By Nelly K [Mastered By Royal Buoy Beats].mp3', title: 'Muwumbo' },
    { src: 'songs/Nelly K - Driver.mp3', title: 'Driver' },
    { src: 'songs/Ntumileko By Nelly K [Royal Buoy Beats].mp3', title: 'Ntumileko' },
    { src: 'songs/Oli Wanyo by nelly k owekyenge.mp3', title: 'Oli Wanyo' },
    { src: 'songs/Sawa Meka By Nelly K [Royal Buoy Beats].mp3', title: 'Sawa Meka' },
    { src: 'songs/Vokoz Oli Wanyo By Nelly K [Royal Buoy Beats].mp3', title: 'Vokoz Oli Wanyo' },
    { src: 'songs/Wanchikicha by Nelly K Owekyenge (2).mp3', title: 'Wanchikicha' }
];
